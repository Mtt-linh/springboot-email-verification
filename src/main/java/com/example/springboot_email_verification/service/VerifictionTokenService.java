package com.example.springboot_email_verification.service;
...
import com.example.springboot_email_verification.repository.UserRepository;
import com.example.springboot_email_verification.repository.VerificationTokenRepository;
...
@Service
public class VerifictionTokenService {
    private UserRepository userRepository;
    private VerificationTokenRepository verificationTokenRepository;
    private SendingMailService sendingMailService;
    @Autowired

    public VerifictionTokenService(UserRepository userRepository, VerificationTokenRepository verificationTokenRepository, SendingMailService sendingMailService) {
    ...
    public ResponseEntity<String> verifyEmail(String token){
        ...
        if (verificationToken.getConfirmedDateTime().isBefore(LocalDateTime.now())){
